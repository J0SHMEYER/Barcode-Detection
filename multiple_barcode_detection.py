...
def computeBoundingBox(pixelArr, imageWid, imageHei, dict, start):
...
def main():
    ...
    gau_result = gaussianFilter(gau_result, imageWid, imageHei)
    ...
    pxArr, dict = computeConnectedComponent(step5, imageWid, imageHei)
    ...
    for i in dict:
        ...
        bbox_min_x, bbox_max_x, bbox_min_y, bbox_max_y = computeBoundingBox(pxArr, imageWid, imageHei, dict, start)
